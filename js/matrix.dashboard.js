...
$(document).ready(function(){
    ...
    //  $('#list').click(function(event){event.preventDefault();$('#bids .item').addClass('list-group-item');});
    // $('#grid').click(function(event){event.preventDefault();$('#bids .item').removeClass('list-group-item');
    // $('#bids .item').addClass('grid-group-item');});
    $('.bids #list').trigger('click');
